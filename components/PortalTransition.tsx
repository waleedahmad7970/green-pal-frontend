...
export default function PortalTransition() {
  ...
  return (
    <section ref={sectionRef} className="relative h-[320vh]" aria-hidden="true">
      <div
        ref={contentRef}
        className="sticky top-0 h-[100svh] bg-surface overflow-hidden flex items-center justify-center"
      >
