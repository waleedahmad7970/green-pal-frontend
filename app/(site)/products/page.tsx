              ...
              >
                ...
                <div className="flex flex-col flex-grow p-6 md:p-8">
                  ...
                  <div className="flex items-center justify-between pt-5 border-t line-rule">
                    <span className="inline-flex items-center justify-center px-5 h-8 rounded-full bg-surface border line-rule text-xs  uppercase tracking-widest font-bold group-hover:bg-[#02d683] group-hover:border-[#02d683] group-hover:text-ink transition-colors">
                      Inquire for order
                    </span>
